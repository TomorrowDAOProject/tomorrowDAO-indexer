...
[DependsOn(
    typeof(TomorrowDAOIndexerOrleansTestBaseModule),
    typeof(TomorrowDAOIndexerPluginModule),
...
public class TomorrowDAOIndexerPluginTestModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpAutoMapperOptions>(options => { options.AddMaps<TomorrowDAOIndexerPluginTestModule>(); });
    ...
    {
        var types = GetTypesAssignableFrom<IIndexBuild>(typeof(TomorrowDAOIndexerPluginModule).Assembly);
