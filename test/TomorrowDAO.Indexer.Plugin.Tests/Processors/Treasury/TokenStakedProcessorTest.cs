...
public class TokenStakedProcessorTest : TomorrowDAOIndexerPluginTestBase
{
    [Fact]
    public async Task HandleEventAsync_Test()
    {
        ...
        await MockEventProcess(TokenStaked(), TokenStakedProcessor);
        ...
        var treasuryRecordId = IdGenerateHelper.GetId(ChainAelf, "c1e625d135171c766999274a00a7003abed24cfe59a7215aabf1472ef20a2da2", DAOCreator, TreasuryRecordType.StakeToken);
        ...
        treasuryRecordIndex.TreasuryRecordType.ShouldBe(TreasuryRecordType.StakeToken);
    }
