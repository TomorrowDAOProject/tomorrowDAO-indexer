    ...
    where TEvent : IEvent<TEvent>, new()
{
    ...
    protected ParliamentProcessorBase(ILogger<AElfLogEventProcessorBase<TEvent, LogEventInfo>> logger,
    ...
    {
        return ContractInfoOptions.ContractInfos[chainId].ParliamentContractAddress;
    }
}